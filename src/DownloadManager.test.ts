...
describe("DownloadManagerのテスト", () => {
  ...
  test("generateZipのテスト - 正常なケース", async () => {
    const inputHTMLString = `
      <div>
        <img src="https://pic.nijie.net/01/nijie/test/00/000000/illust/sample1.jpg">
  ...
  test("generateZipのテスト - 画像拡張子のカスタマイズ", async () => {
    const inputHTMLString = `
      <div>
        <img src="https://pic.nijie.net/01/nijie/test/00/000000/illust/sample1.jpg">
      </div>
  ...
  test("generateZipのテスト - 画像が見つからない場合", async () => {
    document.body.innerHTML = "<div>No images here</div>";
  ...
  test("generateZipのテスト - 画像ダウンロード失敗時", async () => {
    const inputHTMLString = `
      <div>
        <img src="https://pic.nijie.net/01/nijie/test/00/000000/illust/sample1.jpg">
      </div>
  ...
  test("downloadPostのテスト - デフォルトのファイル名", async () => {
    const inputHTMLString = `
      <div>
        <img src="https://pic.nijie.net/01/nijie/test/00/000000/illust/sample1.jpg">
      </div>
  ...
  test("downloadPostのテスト - head.titleからファイル名を取得", async () => {
    const inputHTMLString = `
      <div>
        <img src="https://pic.nijie.net/01/nijie/test/00/000000/illust/sample1.jpg">
      </div>
  ...
  test("downloadPostのテスト - カスタムファイル名", async () => {
    const inputHTMLString = `
      <div>
        <img src="https://pic.nijie.net/01/nijie/test/00/000000/illust/sample1.jpg">
      </div>
